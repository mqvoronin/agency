...
const Navbar = ({ theme, setTheme }) => {
  ...
  return (
    <div
      className="flex justify-between items-center px-4 sm:px-12 lg:px-24 xl:px-30 
    ...
    >
      ...
      <div
        ...
        max-sm:fixed top-0 bottom-0 right-0 max-sm:min-h-screen max-sm:h-full max-sm:flex-col max-sm:bg-primary 
         max-sm:text-white max-sm:pt-20 flex sm:items-center  max-md:gap-10 md:gap-27 transition-all`}
      >
        <img
